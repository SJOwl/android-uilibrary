...
//    val developmentScreen = LIST_PARTICLES
    val developmentScreen = PARTICLES_LINKED

    val screens = listOf(
        ScreenData("Home", MAIN) { ListFragment.createArguments(intArrayOf(LIST_BUTTONS, LIST_NAVBAR, LIST_CHARTS, LIST_TRANSITIONS, LIST_PROGRESSBAR, LIST_FAB, LIST_CHECKBOX)) },

        ScreenData("Bottombars", LIST_NAVBAR) { ListFragment.createArguments(intArrayOf(NAVBAR_FLUID, NAVBAR_ROTATION, NAVBAR_SPREAD)) },
        ...
        ScreenData("Particles", LIST_PARTICLES) { ListFragment.createArguments(intArrayOf(PARTICLES_LINKED, PARTICLES_SNOW)) },
